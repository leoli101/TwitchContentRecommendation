...
public class ItemRecommender {
    ...
    private List<Item> recommendByFavoriteHistory(
        ...
        // Count the favorite game IDs from the database for the given user. E.g. if the favorite game ID list is ["1234", "2345", "2345", "3456"], the returned Map is {"1234": 1, "2345": 2, "3456": 1}
