...
public class TwitchClient {
    private static final String TOKEN = "Bearer u31i6lboqz27oslehmjp36boknc6dp";
    private static final String CLIENT_ID = "8xmecsdlj81kc0ni9wgh5uh8cwp9zj";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        ResponseHandler<String> responseHandler = response -> {
            ...
            return obj.getJSONArray("data").toString(); // data is an array in json
        };
